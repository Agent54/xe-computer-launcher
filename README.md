...
2. Open the `Darc.dmg` file.
3. Drag the `Darc` icon to Applications folder.
...
> [!NOTE]
> If the package cannot open, launch Terminal and type `xattr -d com.apple.quarantine Darc.dmg` to bypass Gatekeeper.
