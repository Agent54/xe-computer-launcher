...
enum GuestRouterError: LocalizedError {
    ...
    var errorDescription: String? {
        "This VM predates the guest router socket and resource mount. Its data has been kept intact. Migrate the VM configuration before using application routing; Compose management remains available."
    }
}
